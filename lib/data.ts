...
const buildRooms = (): Room[] => {
  ...
  for (let i = 1; i <= 30; i++) {
    ...
    const type: RoomType = i % 2 === 0 ? 'double' : 'single'
    r.push({ 
      id: i, 
      number: i.toString(), 
      floor, 
...
export const rooms: Room[] = (() => {
  ...
  setS('1','occupied'); setS('2','occupied'); setS('3','cleaning')
  setS('6','occupied'); setS('7','maintenance')
  setS('11','occupied'); setS('12','occupied')
  setS('16','occupied')
  setS('21','occupied')
  return r
})()
...
export const reservations: Reservation[] = [
  { id:1, guest:'María González', room:'1', checkIn:'28/02', checkOut:'01/03', status:'checked-in', amount:89, nights:1 },
  { id:2, guest:'Carlos Ruiz', room:'2', checkIn:'28/02', checkOut:'02/03', status:'checked-in', amount:267, nights:3 },
  { id:3, guest:'Ana López', room:'6', checkIn:'28/02', checkOut:'01/03', status:'checked-in', amount:129, nights:1 },
  { id:4, guest:'Lucía Morales', room:'7', checkIn:'28/02', checkOut:'01/03', status:'pending', amount:129, nights:1 },
  { id:5, guest:'Roberto Silva', room:'11', checkIn:'26/02', checkOut:'03/03', status:'checked-in', amount:903, nights:7 },
  { id:6, guest:'Pedro Martínez', room:'12', checkIn:'28/02', checkOut:'03/03', status:'confirmed', amount:645, nights:5 },
  { id:7, guest:'Valentina Ríos', room:'16', checkIn:'27/02', checkOut:'01/03', status:'checked-in', amount:258, nights:2 },
  { id:8, guest:'Diego Castro', room:'21', checkIn:'28/02', checkOut:'02/03', status:'confirmed', amount:356, nights:4 },
]
