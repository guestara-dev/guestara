...
// FIX #1: Cookie name must be 'g_auth' to match middleware.ts
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // FIX #1: Save as 'g_auth' so middleware, configuracion and AutoLogout all read the same cookie
    ...
    // Keep 'session' for any legacy reads (optional backward compat)
    setCookie('session', payload, 1)
    try {
